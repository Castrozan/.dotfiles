...
readonly AUDIO_SERVICE_QML="$(cd "$(dirname "${BATS_TEST_FILENAME}")/../../../../.." && pwd)/machine-configuration/desktop/quickshell/bar/program-configuration/dashboard/services/AudioService.qml"

...
in
{
  home.packages = [
    ...
    '')
    (pkgs.writeShellScriptBin "pinchtab-act-and-snapshot" (
      builtins.readFile ./scripts/pinchtab-act-and-snapshot
    ))
    (pkgs.writeShellScriptBin "pinchtab-ensure-running" (
      builtins.readFile ./scripts/pinchtab-ensure-running
    ))
    (pkgs.writeShellScriptBin "pinchtab-fill-form" (builtins.readFile ./scripts/pinchtab-fill-form))
    (pkgs.writeShellScriptBin "pinchtab-navigate-and-snapshot" (
      builtins.readFile ./scripts/pinchtab-navigate-and-snapshot
    ))
    (pkgs.writeShellScriptBin "pinchtab-screenshot" (builtins.readFile ./scripts/pinchtab-screenshot))
    (pkgs.writeShellScriptBin "pinchtab-switch-mode" (builtins.readFile ./scripts/pinchtab-switch-mode))
  ];
}

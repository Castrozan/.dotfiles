...
<delegation>
Implementation work goes to executor agents. Spawn them using the session skill's claude capability (scripts/spawn-claude.sh) or TeamCreate for coordinated multi-agent work.

...
in
{
  ...
  home.file = builtins.listToAttrs (map (name: {
    ...
    value = { source = plugins.${name}; };
  }) pluginNames) // {
    # JSON configs
    "vault/.obsidian/community-plugins.json".text = builtins.toJSON pluginNames;

    "vault/.obsidian/core-plugins.json".text = builtins.toJSON [
    ...
    "vault/.obsidian/hotkeys.json".text = builtins.toJSON {

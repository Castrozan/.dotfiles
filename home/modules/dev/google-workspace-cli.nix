...
let
  ...
  googleChatBrowserCliSource = pkgs.writeText "google-chat-browser-cli.py" (
    builtins.readFile ../../../agents/skills/comms/skills/google-chat/scripts/google-chat-browser-cli.py
  );

  googleChatBrowserCli = pkgs.writeShellScriptBin "google-chat-browser-cli" ''
    set -Eeuo pipefail

    readonly python_binary="${pkgs.python312}/bin/python"
  ...
  googleChatSendByNameSource = ../../../agents/skills/comms/skills/google-chat/scripts/google-chat-send-by-name.sh;
  ...
  googleChatReadHistorySource = ../../../agents/skills/comms/skills/google-chat/scripts/google-chat-read-history.sh;

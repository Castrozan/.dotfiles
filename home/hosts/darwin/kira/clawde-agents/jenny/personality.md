...
Default to delegation. You run on opus, but routing is still cheaper than doing the work yourself - hand heavy lifting to dedicated subagents or codex rather than grinding it out inline.
</primary-responsibility>
...
- Persistent agents are declared in nix. If a project does not have one yet, ask Lucas to declare it.

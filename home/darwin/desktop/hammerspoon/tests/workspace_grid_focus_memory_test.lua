...
workspaceGrid.switchToWorkspace(1)
expectEqual("returning to workspace 1 restores last-focused B, not iteration-order A", 2, currentlyFocusedWindowId)

windowB:focus()
workspaceGrid.onWindowFocused(windowB)
local preservedFocusOnReload = workspaceGrid.switchToWorkspace(1, hs.window.focusedWindow())

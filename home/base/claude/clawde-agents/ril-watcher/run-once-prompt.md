...
what only activation can prove, and your verdict. Merge and `ril record` it now when dropping that commit undoes it
completely; otherwise leave it open and record nothing, since the claim expiring on its own is how Lucas or another
session takes it over and your next wake handles his answer.
</opening_it>

...
| `skill-injection/`         | the machine-tier skill deployment (curated interactive set plus generated `core` and `all-skills` index), the `claude-interactive` wrapper, and the shared skill-set builders at `agents/skill-set-builders.nix`                                                                                                                                                                                                                                                                                                |

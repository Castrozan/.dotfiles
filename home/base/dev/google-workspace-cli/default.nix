...
let
  ...
  googleChatBrowserCliSource = pkgs.writeText "google-chat-browser-cli.py" (
    builtins.readFile ./scripts/google-chat-browser-cli.py
  );
  ...
  googleChatSendByNameSource = ./scripts/google-chat-send-by-name.sh;
  ...
  googleChatReadHistorySource = ./scripts/google-chat-read-history.sh;

...
let
  ...
  googleChatBrowserCliSource = pkgs.writeText "google-chat-browser-cli.py" (
    builtins.readFile ../../../agents/skills/google-chat/scripts/google-chat-browser-cli.py
  );
  ...
  googleChatSendByNameSource = ../../../agents/skills/google-chat/scripts/google-chat-send-by-name.sh;
  ...
  googleChatReadHistorySource = ../../../agents/skills/google-chat/scripts/google-chat-read-history.sh;

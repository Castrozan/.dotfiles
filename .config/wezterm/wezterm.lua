...
local config = {
	...
	keys = {
		...
		{ key = "e", mods = "CTRL|SHIFT", action = wezterm.action.SendString("\x1b[101;6u") },
		{ key = "b", mods = "CTRL|SHIFT", action = wezterm.action.SendString("\x1b[98;6u") },
		{ key = "o", mods = "CTRL|SHIFT", action = wezterm.action.SendString("\x1b[111;6u") },
		{ key = "f", mods = "CTRL|SHIFT", action = wezterm.action.SendString("\x1b[102;6u") },
		{ key = "p", mods = "CTRL|SHIFT", action = wezterm.action.SendString("\x1b[112;6u") },
		{ key = "k", mods = "CTRL|SHIFT", action = wezterm.action.SendString("\x1b[107;6u") },
		{ key = "j", mods = "CTRL|SHIFT", action = wezterm.action.SendString("\x1b[106;6u") },

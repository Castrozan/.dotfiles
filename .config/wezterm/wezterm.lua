...
local config = {
	...
	keys = {
		...
		{ key = "m", mods = "CTRL|SHIFT", action = wezterm.action.Nop },
		...
		{ key = "PageUp", mods = "CTRL|SHIFT", action = wezterm.action.SendString("\x1b[5;6~") },
		{ key = "PageDown", mods = "CTRL|SHIFT", action = wezterm.action.SendString("\x1b[6;6~") },

...
Singleton {
    ...
    readonly property color background: themeData ? rgbStringToQtColor(themeData.backgroundRgb, 0.92) : Qt.rgba(0, 0, 0, 0.92)
    ...
    readonly property color backgroundTranslucent: themeData ? rgbStringToQtColor(themeData.backgroundRgb, 0.95) : Qt.rgba(0, 0, 0, 0.95)

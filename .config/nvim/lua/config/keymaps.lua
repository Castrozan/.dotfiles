...
map("n", "<C-S-Right>", "vw", { desc = "Select to next word" })
map("n", "<C-S-Left>", "vb", { desc = "Select to previous word" })
map("i", "<C-S-Right>", "<esc>vw", { desc = "Select to next word" })
map("i", "<C-S-Left>", "<esc>vb", { desc = "Select to previous word" })
map("v", "<C-S-Right>", "w", { desc = "Extend selection to next word" })
map("v", "<C-S-Left>", "b", { desc = "Extend selection to previous word" })

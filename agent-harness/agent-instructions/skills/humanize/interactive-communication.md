...
`brief:` the standing purpose of this work, written to stay true next week. No recency bias and no progress report.
...
The three labels together stay under 100 words and the whole reply under 120 prose words, counting lists but no
visual. One list stays within 5 lines and 20 words per line. Move overflow into a visual rather than deleting a fact.
</response-shape>

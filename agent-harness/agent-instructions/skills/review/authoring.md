...
sub-file references resolve; do not re-report those. Skip rules covered by `coding` (naming, staging, commit format)
and `compliance.md` (Python over Bash, test-first, local-first).

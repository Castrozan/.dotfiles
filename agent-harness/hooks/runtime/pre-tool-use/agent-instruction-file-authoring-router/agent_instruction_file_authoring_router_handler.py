...
AUTHORING_STANDARDS_DIRECTIVE = (
    ...
    "Use Skill(skill='dotfiles:instructions') where supported; on Codex, run a standalone "
    "cat ~/.local/share/agent-plugins/dotfiles/plugin/skills/instructions/SKILL.md and read its complete output. "
    "Also load the docs skill with Skill(skill='dotfiles:docs') or, on Codex, "
    "cat ~/.local/share/agent-plugins/dotfiles/plugin/skills/docs/SKILL.md. Read any repo-local instruction-authoring "

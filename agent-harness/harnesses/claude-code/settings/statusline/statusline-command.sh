...
# shellcheck disable=SC2034
{
	...
	readonly GIT_UPSTREAM_FETCH_INTERVAL_SECONDS=60
	readonly GIT_UPSTREAM_FETCH_TIMEOUT_SECONDS=10
}
...
_render_statusline_from_json_input() {
	...
	local git_segment model_segment context_window_segment rate_limit_segment session_id_segment servant_segment

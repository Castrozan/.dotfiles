...
`agent-harness/agent-instructions/dotfiles-checkout-agent-surfaces/dotfiles-repo-agent-instructions-home-manager.nix` writes `AGENTS.md` into the same checkout.

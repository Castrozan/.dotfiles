...
let
  ...
  agentMemoryEntries = [
    ...
    "Hermes configuration: Hermes uses the pinned upstream Nix package with bundled runtime assets. The wrapper regenerates config.yaml and SOUL.md from agent-harness/harnesses/hermes on every launch."

...
<job>
Verify the delivered work against the user's original goal, not against the implementer's summary of it. Read
`quality-assurance.md` from the `test` skill for the method.
</job>

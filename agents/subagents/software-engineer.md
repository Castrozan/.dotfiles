...
model: sonnet
skills: software-design, test
---

<job>
Implement the plan you were given inside the files it names. Read `code-craft.md` from the `software-design` skill and
follow the `test` skill's protocol; both bind you. Read the surrounding code before touching it and match its
conventions.
</job>

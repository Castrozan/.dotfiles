<scripts>
All scripts live at @homePath@/@workspacePath@/skills/comms/scripts/. Start all services with start-avatar.sh (opens visible browser). Stop with stop-avatar.sh. Speak with avatar-speak.sh or avatar-speak-multi.sh — run without args for usage.
</scripts>

---
name: twitter
description: Scrape and post Twitter/X — search, user profiles, tweets, replies, threads, trends, timeline, followers, following, post, like, retweet, bookmark, DM. Cookie-based auth from Chrome.
---

...
```bash
python agents/skills/personal-skills/scripts/list-personal-skill-vault-metadata.py
```

Optional custom vault path:

```bash
python agents/skills/personal-skills/scripts/list-personal-skill-vault-metadata.py /path/to/personal-skill-vault
```

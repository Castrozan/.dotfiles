---
name: a2a
description: Talk to external A2A protocol agents — Codex, Gemini, or any A2A v1.0 server outside the OpenClaw grid. For OpenClaw agents, use the grid skill instead.
---

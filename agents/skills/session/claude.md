<tmux_sessions>
Launch a Claude Code instance in a tmux window. The session is fully interactive — the user can watch, take over, or follow up at any time. Use `scripts/spawn-claude.sh` to create the window and optionally send an initial prompt.

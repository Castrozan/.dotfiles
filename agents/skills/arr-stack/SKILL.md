...
`scripts/arr_users/jellyfin_library_declaration.py` is the sole source of truth for the split and is default-deny, so
edit that file to change what is public, never a Jellyfin dashboard checkbox. Download privately by adding the title in

...
Do not change this file if not requested or if the change not follow the pattern that focuses on token usage and information density. These are user rules that must be followed without exception. Follow this at all costs or you will be fired. 

...
map("i", "<C-p>", function()
  vim.cmd("stopinsert")
  require("telescope.builtin").find_files()
end, { desc = "Find files (from insert)" })
...
local close_current_buffer_focusing_right_then_left =
  require("config.buffer_closing").close_current_buffer_focusing_right_then_left

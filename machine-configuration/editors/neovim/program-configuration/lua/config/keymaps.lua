...
local missing_imports = require("config.missing_imports")
...
map("n", "<C-.>", vim.lsp.buf.hover, { desc = "Show symbol information" })
map("n", "<C-CR>", missing_imports.add, { desc = "Import the symbol under the cursor" })
...
map({ "n", "i", "v" }, "<C-S-Down>", line_jumping.jump_buffer_down, { desc = "Jump 7 lines down" })
map({ "n", "i", "v" }, "<C-S-Up>", line_jumping.jump_buffer_up, { desc = "Jump 7 lines up" })

...
alias b='btop'
alias c='code'
alias ca='claude-interactive'
alias cl='claude-interactive'
alias cla='claude-interactive'
alias cal='claude-interactive'
alias clau='claude-interactive'
alias claud='claude-interactive'
alias claude='claude-interactive'
alias lca='claude-interactive'
alias co='codex'
alias cat='cat'
alias catt='bat'
alias cd.='cd ..'
alias cd..='cd ..'
alias code='code . -n'
. "$HOME/.dotfiles/machine-configuration/terminal/shell/bash/program-configuration/cursor.sh"
alias d='lazydocker'
...
PRIVATE_SHELL_ALIASES="$HOME/.dotfiles/private-configuration/shell/aliases.sh"

...
let
  ...
  installerScriptPath = "${dotfilesDir}/machine-configuration/operating-system/endpoint-agent-suppression/forticlient-disable-update/install-systemd-service";
  disableScriptSourcePath = "${dotfilesDir}/machine-configuration/operating-system/endpoint-agent-suppression/forticlient-disable-update/disable-forticlient-update";

...
let
  ...
  installerScriptPath = "${dotfilesDir}/machine-configuration/operating-system/endpoint-agent-suppression/sophos-disable-plugins/install-systemd-service";
  stopScriptSourcePath = "${dotfilesDir}/machine-configuration/operating-system/endpoint-agent-suppression/sophos-disable-plugins/stop-sophos-noisy-plugins";
